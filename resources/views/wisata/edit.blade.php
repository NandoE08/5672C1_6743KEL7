...
<div class="col-sm-12">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="{{ url('admin/wisata/edit') }}">Edit</a>
            </li>
        </ul>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade active in">
                ...
                <div class="clearfix"><h2></h2></div>
                    <div class="col-sm-6">
                    {{ csrf_field() }}
                        {!! Form::model($wisata,['url'=>'admin/wisata/edit/'.$wisata->id,'class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
